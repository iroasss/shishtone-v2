...
<head>
    ...
    <title>Report Animal Cruelty  • FurFect Match</title>
</head>
<>
...
<h2>REPORT CRUELTY TO ANIMALS</h2>
    ...
    <form action="submit_application.php" method="POST">
        <div class="form-group">
            <label for="reporting-issue">The issue I'm reporting involves: <span class="required">*</span></label>
            <input type="text" id="reporting-issue" name="reporting-issue" required>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <label for="subject-line">Subject Line of E-mail</label>
                <input type="text" id="subject-line" name="subject-line">
            </div>
        </div>
