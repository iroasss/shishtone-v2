    ...
    <div class="form-section active" id="step1">
      ...
      <form action="submit_application.php" method="POST">
        <div class="form-container">
          ...
          <div class="form-group">
            <label for="typeofreport">What are you reporting? <span class="required">*</span></label>
            <div>
              <input type="checkbox" id="lost" name="typeofreport" value="lost">
              <label for="lost">Lost Pet</label>
            </div>
            <div>
              <input type="checkbox" id="found" name="typeofreport" value="found">
